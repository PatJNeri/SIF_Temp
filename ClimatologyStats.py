...
for q in [80, 75, 66, 60, 50, 40, 33, 25]:
    ...
    ax[0,0].scatter(try31[5,:], try31[6,:], c=try31[2,:], cmap='jet')
    ax[0,1].scatter(try31[7,:], try31[8,:], c=try31[3,:], cmap='jet')
    #ax[0].set_xlim((-32, 65))
    #ax[0].set_ylim((0, 25))
    ax[1,0].scatter(try32[5,:], try32[6,:], c=try32[2,:], cmap='jet')
    ax[1,1].scatter(try32[7,:], try32[8,:], c=try32[3,:], cmap='jet')
    #ax[1].set_xlim((-32, 65))
    #ax[1].set_ylim((0, 25))
    ax[2,0].scatter(try33[5,:], try33[6,:], c=try33[2,:], cmap='jet')
    ax[2,1].scatter(try33[7,:], try33[8,:], c=try33[3,:], cmap='jet')
    #ax[2].set_xlim((-32, 65))
    #ax[2].set_ylim((0, 25))
# %%
